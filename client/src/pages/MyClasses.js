...
const MyClasses = () => {
    ...
    return (
        <div>
            {data.length === 0 ? <h1 className="text-4xl font-bold m-10">You have no classes yet. Would you like to enroll in classes? <Link className="text-indigo-400" to={'/classrooms/join'}>Click here!</Link></h1> : <h1 className="text-4xl font-bold m-10 text-center"> This is where you found the classes you enrolled in! </h1>}
            <div className="container mx-auto h-[100vh] my-5 gap-5 p-4">
